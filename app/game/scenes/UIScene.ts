...
export class UIScene extends Phaser.Scene {
  ...
  create() {
    ...
    const bestInit = Math.floor(Number(localStorage.getItem("devin-game-best") ?? 0));
    ...
    // Event panel (route)
    this.add
      .text(GAME_WIDTH / 2, 12, "DAILY ROUTE", {
        fontFamily: "sans-serif",
        fontSize: "16px",
        color: "#ffd23a",
        fontStyle: "bold",
    ...
    // ---------- "SURVIVE THE RUN" panel (top-right, before pause) ----------
    ...
    this.add
      .text(survPanelX + survPanelW / 2, 22, "SURVIVE THE RUN", {
        fontFamily: "sans-serif",
        fontSize: "10px",
        color: "#ffffff",
        fontStyle: "bold",
    ...
    this.add
      .text(mmX + mmW / 2, bottomY + 11, "SUPER METER", {
        fontFamily: "sans-serif",
        fontSize: "13px",
        color: "#32d264",
        fontStyle: "bold",
