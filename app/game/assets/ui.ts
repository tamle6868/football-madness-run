  ...
  if (!scene.textures.exists("logo")) {
    ...
    commitCanvasAsTexture(
      ...
      const drawText = (
        ...
        if (text !== "GAME") ctx.strokeText(text, 0, 0);
        ctx.fillStyle = grad;
        ctx.fillText(text, 0, 0);
        ctx.restore();
      };

      drawText("DEVIN", 198, 58, 56, "#ffffff", "#a9dfff");
      drawText("GAME", 198, 120, 60, "#fff08a", "#ff9a1f", -0.11);
      drawText("STARTER", 180, 182, 50, "#dff4ff", "#36c8ff");
